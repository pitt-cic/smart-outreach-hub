...
def send_to_outbound_sms_queue(phone_number: str, agent_response: Optional[AgentResponseWrapper]) -> bool:
    """
...
def process_message_sync(phone_number: str, message: str, message_id: str, context: Any) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        try:
            response = loop.run_until_complete(process_message(phone_number, message, message_id))
