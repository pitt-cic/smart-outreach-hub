...
def create_test_campaign(campaign_id: str, name: str, message_template: str, campaign_details: str | None = None):
...
def add_campaign_message(phone_number: str, campaign_name: str, campaign_message: str, campaign_id: str = None, campaign_details: str | None = None):
